...
let A = class extends n {
  ...
  turnOnLight(t) {
    const {
      width: e,
      height: l
    } = document.documentElement.getBoundingClientRect(), i = document.createElement("style");
    i.id = "dark-light-mode-style", i.innerHTML = `body::after {
      content: "";
      position:absolute;
      top: 0;
      left: 0;
      ...
      background: radial-gradient(
        circle at
        var(--dark-light-mode-x, ${t.pageX}px)
        var(--dark-light-mode-y, ${t.pageY}px),
        rgb(255, 255, 0, 0.3),
        rgb(0, 0, 0, 1) 200px
      );
    }`, document.head.appendChild(i), ["mousemove", "touchstart", "touchmove", "touchend"].forEach((o) => {
      document.addEventListener(o, this.updateLight, !1);
    });
  }
  turnOffLight() {
    const t = document.querySelector("#dark-light-mode-style");
    t.parentNode.removeChild(t), ["mousemove", "touchstart", "touchmove", "touchend"].forEach((e) => {
      document.removeEventListener(e, this.updateLight, !1);
    });
  }
  updateLight(t) {
    if (!t.pageX || !t.pageY)
    ...
    e.style.setProperty("--dark-light-mode-x", `${t.pageX}px`), e.style.setProperty("--dark-light-mode-y", `${t.pageY}px`);
  }
  render() {
    return n.h(h, null, n.h("div", {
      class: "toggle"
    }, n.h("div", {
      class: "track"
    }, n.h("div", {
