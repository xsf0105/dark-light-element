...
@customElement({ tag: "dark-light-element", style })
class DarkLightElement extends QuarkElement {
  componentDidMount() {
  ...
  turnOnLight(e) {
    ...
    ["mousemove", "touchstart", "touchmove", "touchend"].forEach((x) => {
      document.addEventListener(x, this.updateLight, false);
    });
  }
  ...
  turnOffLight() {
    ...
    ["mousemove", "touchstart", "touchmove", "touchend"].forEach((x) => {
      document.removeEventListener(x, this.updateLight, false);
    });
  }
